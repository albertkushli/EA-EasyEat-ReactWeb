  ...
  const plans = [
    {
      ...
      price: "0€",
      period: "para siempre",
      description: "Ideal para pequeños restaurantes que quieren empezar a digitalizar su fidelización.",
      features: [
    ...
    },
    {
      ...
      price: "29€",
      period: "/ mes",
      description: "Para restaurantes en crecimiento que quieren fidelizar clientes ilimitadamente.",
      features: [
    ...
    },
    {
      ...
      price: "79€",
      period: "/ mes",
      description: "La solución total para franquicias y restaurantes enfocados en maximizar ingresos.",
      features: [
    ...
    <div className="max-w-7xl mx-auto w-full px-4 md:px-0 mb-12">
      ...
      {showCelebration && (
        ...
        >
          ...
          <div>
            <h2 className="text-2xl font-black tracking-tight">¡Suscripción Completada con Éxito!</h2>
            <p className="text-sm font-semibold opacity-90 mt-1 max-w-2xl leading-relaxed">
              Tu restaurante ha sido actualizado exitosamente al plan <span className="underline uppercase font-black">{billingPlanUrlParam}</span>. Ahora disfrutas de todos los privilegios premium de EasyEat.
            </p>
          </div>
          <button 
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 font-medium">Controla tu plan actual, límite de recompensas y facturación.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 flex flex-col gap-4 md:col-span-2">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Límite de Recompensas Activas</p>
      ...
      <h2 className="text-xl font-black text-gray-800 tracking-tight mb-6">Elige el plan ideal para tu restaurante</h2>
                ...
                <ul className="space-y-4 mb-8">
                  {plan.features.map((feat, i) => (
                    <li key={i} className="flex items-center gap-3 text-xs font-bold text-slate-600">
                      <div className={`p-1 bg-gray-50 rounded-full shrink-0 ${plan.popular ? "text-orange-500" : "text-slate-500"}`}>
      ...
      <div className="mt-12 text-center p-6 bg-slate-50 rounded-3xl border border-slate-100 max-w-xl mx-auto flex items-center justify-center gap-3 text-gray-500">
        ...
        <p className="text-xs font-semibold text-left leading-relaxed">
          Los pagos se procesan de forma segura a través de **Stripe Checkout**. No guardamos datos bancarios ni de tarjetas de crédito en nuestros servidores corporativos de EasyEat.
        </p>
      </div>
    </div>
  );
